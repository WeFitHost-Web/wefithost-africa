        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <img
                src={logo}
                alt="WefitHost Africa"
                className="h-8 w-auto mb-2"
              />
            </Link>
            <p className="text-sm leading-relaxed max-w-sm text-slate-400">
              High-performance infrastructure built specifically for African
              success. Global speed with local reliability.
            </p>
          ...
          <div className="space-y-4">
            <h4 className="text-white font-bold text-[11px] uppercase tracking-[0.2em]">
              Hosting
            </h4>
          ...
          <div className="space-y-6">
            <div>
              <h4 className="text-white font-bold text-[11px] uppercase tracking-[0.2em] mb-4">
                Currency
              </h4>
              <select
                value={currency.label}
                onChange={handleCurrencyChange}
                className="bg-slate-800/50 border border-slate-700 text-slate-200 text-sm p-3 rounded-xl w-full outline-none focus:ring-2 focus:ring-indigo-600 appearance-none cursor-pointer"
              >
                {Object.values(currencies).map((c) => (
                  <option key={c.code}>{c.label}</option>
                ))}
              </select>
            </div>
