  ...
  const vpsTech = [
    {
      ...
      description:
        "Dedicated physical cores running at high-frequency turbo speeds. Zero resource theft.",
    },
    {
      icon: <HardDrive size={24} />,
      title: "Enterprise Gen4 NVMe",
      description:
        "Sustained read/write speeds exceeding 7,000 MB/s. Databases load instantly.",
    },
    {
      icon: <Terminal size={24} />,
      title: "Full Root Control",
      description:
        "Absolute software freedom. Install Docker, custom kernels, and bespoke security.",
    },
    {
      icon: <Database size={24} />,
      title: "Local IP Spaces",
      description:
        "Dedicated clean IP addresses geolocated in Nigeria or Kenya to maximize local SEO.",
    },
    {
      icon: <Activity size={24} />,
      title: "Low Latency Networking",
      description:
        "Direct peering with local ISPs to ensure sub-20ms response times for African users.",
    },
  ];
    ...
    <div className="bg-[#0b1120] text-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-slate-400 text-lg mb-10 max-w-lg leading-relaxed">
              Ditch crowded shared environments. Deploy a secure virtual private
              server in Nigeria or Kenya with dedicated reservations.
            </p>
          ...
          <div className="hidden lg:block relative">
            ...
            <div className="relative p-10 bg-slate-900 border border-slate-800 rounded-[3rem] shadow-3xl font-mono text-xs">
              ...
              <p className="text-emerald-400 mt-2">
                [✓] Allocating dedicated NVMe array...
              </p>
              <p className="text-emerald-400">
                [✓] Binding local Lagos IPv4...
              </p>
              <p className="text-indigo-300 mt-4">
                [SUCCESS] Server live at 102.164.21.9
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="mb-16 text-center lg:text-left">
            ...
            <p className="text-slate-500 font-medium">
              Instantly provision exact resource blocks. Scale up seamlessly.
            </p>
          </div>
          <VPSConfigurator
            cores={cores}
      ...
      <section className="py-32 bg-[#0b1120]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-400 mb-12">
            Slide to inspect the enterprise-grade stack powering your partition.
          </p>
      ...
      <section className="py-32 bg-slate-50 px-6">
        <div className="max-w-5xl mx-auto bg-slate-900 p-16 md:p-24 rounded-[4rem] text-center relative overflow-hidden shadow-3xl">
          <ShieldCheck
            size={200}
            className="absolute -bottom-20 -right-20 text-white opacity-5"
          />
          ...
          <p className="text-slate-400 max-w-xl mx-auto mb-12 font-medium">
            Contact our engineers for bare-metal clusters, managed Kubernetes,
            or specialized VPC networking in Africa.
          </p>
